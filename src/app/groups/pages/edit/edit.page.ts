...
export class EditPage implements OnInit {
  ...
  onSubmit() {
    ...
    const query: Observable<FetchResult<UpdateGroupMutation|CreateGroupMutation>> = this.group.id ? this.groupService.update(this.group.id, input as UpdateGroupInput) : this.groupService.create(input as CreateGroupInput);
